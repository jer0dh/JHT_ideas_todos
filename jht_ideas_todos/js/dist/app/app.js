    ...
    var api = {
        ...
        addFromNew: function () {
            ...
            if (newPost.post_title !== '') {
                ...
                this.addToDatabase(newPost, function () {
                    newPost.state = 'inDatabase';
                }, function () {
                    newPost.state = 'error';
                });
                this.initNewPost();
        ...
        //removeIf(production)
        getAjax_url: function () {
            return ajax_url;
        },
        getActions: function () {
            return actions;
        },
        get_ajax_nonce: function () {
            return _ajax_nonce;
        }
    };
